...
try {
    ...
    $query = "INSERT INTO ticket (email_id,subject, task_type, ticket, status, posting_date, user_id) 
              VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $con->prepare($query);
    $stmt->bind_param("ssisisi", $email, $subject, $task_type, $ticket, $status, $posting_date, $user_id);
    $stmt->execute();
